...
export function VocabDetailsModal({ vocab, open, onOpenChange }: VocabDetailsModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold flex items-end gap-2">
                        {vocab.term}
                        {vocab.ipa && <span className="text-base font-normal text-gray-400">/{vocab.ipa}/</span>}
                    </DialogTitle>
                ...
                <div className="space-y-4 mt-4 max-h-[60vh] overflow-y-auto">
                    <section>
                        <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">意味</h3>
                        <p className="text-gray-700 mt-1">{vocab.definition || "No definition available."}</p>
                    </section>

                    {vocab.example && (
                        <section>
                            <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">例文</h3>
                    ...
                    {vocab.synonyms && vocab.synonyms.length > 0 && (
                        <section>
                            <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">類義語</h3>
                    ...
                    {vocab.source_memo && (
                        <section>
                            <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">出典 / メモ</h3>
